...
public class AxlSqlToolkit {
     ...
     */
    public String convertSOAPtoString(SOAPMessage inMessage) throws Exception {
     ...
     */
    public SOAPMessage execute(String currentStatement) {
