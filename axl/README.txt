...
In order to run the AXL SQL toolkit, you must have a recent version of the Java Runtime Environment installed.
The earliest suggested JRE is version 1.4.2_05.  The 1.4.2_08 JRE version is recommended.
